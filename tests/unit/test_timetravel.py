...
from orchestra.core.types import LLMResponse, ToolCall, ToolResult
...
async def test_fork_and_diverge() -> None:
    ...
    new_run_id, fork_state, *_ = await compiled.fork(
        "orig", 0, state_overrides={"val": 10}, event_store=store
    )
